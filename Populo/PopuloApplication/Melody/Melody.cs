    ...
    public static class Melody
    {
        ...
        public static int[][][] dividersInStages= new int[][][]
            {
                ...
                new int[][]
                {
                    new int[]{ 32,35,37,39,40,43,45,47,33,31,28,25,24,23,15,16 },
                    new int[]{ 32,35,37,39,40,43,45,47,33,31,28,25,24,23,15,16 },
            ...
            new int[][][] 

                {
                    ...
                    new int[][] 
                    {
                        ...
                        new int[]{ 71, 78, 84},
                        new int[]{ 78, 84},
                    },//1 - 2	1 - 3	2 - 3	2 - 3	2 - 4	3 - 4	3 - 5	4 - 6	4 - 6	5 - 7	6 - 7	6 - 8	7 - 8	7 - 8	7 - 9	8 - 9
                    new int[][] 
                    {
                        new int[]{39, 40,},
                        new int[]{39, 40, 52,},
                    ...
                    new int[][] //1 - 2	1 - 3	2 - 3	2 - 3	2 - 4	3 - 4	3 - 5	4 - 6	4 - 6	5 - 7	6 - 7	6 - 8	7 - 8	7 - 8	7 - 9	8 - 9
                    {
                        new int[]{35, 44, },
                        new int[]{35, 44, 48, },
                        new int[]{44, 48,},
        ...
        new int[][][][]
             ...
             new int[][][]
            {
                ...
                new int[][] 
                {
                    new int[] {59, 60, 72, 73, 85, 86, 98, 99},
                    new int[] {59, 60, 72, 73, 85, 86, 98, 99},
                    new int[] {59, 60, 72, 73, 85, 86, 98, 99},
                    new int[] {59, 60, 72, 73, 85, 86, 98, 99},
                    new int[] {59, 60, 72, 73, 85, 86, 98, 99},
                ...
                new int[][] 
                {
                    new int[] { 51, 55, 64, 68, 77, 81, 90, 94, 103},
                    new int[] { 51, 55, 64, 68, 77, 81, 90, 94, 103},
                    new int[] { 51, 55, 64, 68, 77, 81, 90, 94, 103},
                    new int[] { 51, 55, 64, 68, 77, 81, 90, 94, 103},
                    new int[] { 51, 55, 64, 68, 77, 81, 90, 94, 103},
