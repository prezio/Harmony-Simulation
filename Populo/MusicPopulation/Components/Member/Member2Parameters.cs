...
namespace MusicPopulation
{
    public partial class Member2
    {
        ...
        public static double RhythmDistortionInfluenceProbability = 0.05;
        public static double DynamicsDistortionInfluenceProbability = 0.05;
        public static double GrowthChance = 0.05;
        public static double ShrinkChance = 0.05;
        public static double PeakMoveChance = 0.05;
        public static int PeakMaxMove = 7;
        public static double PauseChangeChance = 0.05;
        public static int PauseMaxChange = 20;
        public static double InitialRhythmChangeChance = 0.05;
        public static int InitialRhythmMaxChange = 7;
        public static double InitialDynamicsChangeChance = 0.05;
        ...
        public static int PrefferedLength = 16;
        public static int PrefferedPauseLength = 30;
    }
}
